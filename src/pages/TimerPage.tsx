...
export default function TimerPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-8 max-w-xl mx-auto">
            {/* Tabs */}
            <div className="flex p-1 bg-secondary/30 rounded-lg">
                <button
                    onClick={() => setTimerType('flowmodoro')}
                    className={cn(
                        "px-4 py-2 rounded-md text-sm font-medium transition-colors min-w-[100px]",
            ...
            {/* Timer Content Box */}
            <div className="flex flex-col items-center w-full max-w-lg bg-card border border-border rounded-2xl p-8 shadow-sm space-y-8">
                ...
                <div className="flex items-center gap-4">
                    {status === 'running' ? (
                        <button
                            onClick={pause}
                            className="h-16 w-16 rounded-full bg-secondary flex items-center justify-center text-foreground hover:bg-secondary/80 transition-colors"
                        >
